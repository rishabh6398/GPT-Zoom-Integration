...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.symbl.ai
     */
    this.basePath = 'https://api.symbl.ai'.replace(/\/+$/, '');
    ...
    this.authentications = {
      'jwt': {type: 'apiKey', 'in': 'header', name: 'X-API-KEY'}
    };
    /**
