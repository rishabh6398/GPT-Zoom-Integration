...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FollowUpListResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/FollowUpListResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.FollowUpsApi = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.FollowUpListResponse);
  }
}(this, function(ApiClient, FollowUpListResponse) {
  'use strict';

  /**
   * FollowUps service.
   * @module api/FollowUpsApi
   * @version 1.0
   */

  /**
   * Constructs a new FollowUpsApi. 
   * @alias module:api/FollowUpsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/FollowUpsApi~getFollowUpsByConversationIdCallback
     ...
     * @param {module:api/FollowUpsApi~getFollowUpsByConversationIdCallback} callback The callback function, accepting three arguments: error, data, response
