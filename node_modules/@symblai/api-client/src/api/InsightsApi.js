...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InsightsListResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InsightsListResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.InsightsApi = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.InsightsListResponse);
  }
}(this, function(ApiClient, InsightsListResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/InsightsApi~getInsightsByConversationIdCallback
     ...
     * @param {module:api/InsightsApi~getInsightsByConversationIdCallback} callback The callback function, accepting three arguments: error, data, response
