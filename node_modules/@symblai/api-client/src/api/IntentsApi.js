...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/IntentListResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/IntentListResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.IntentsApi = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.IntentListResponse);
  }
}(this, function(ApiClient, IntentListResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/IntentsApi~getIntentsByConversationIdCallback
     ...
     * @param {module:api/IntentsApi~getIntentsByConversationIdCallback} callback The callback function, accepting three arguments: error, data, response
