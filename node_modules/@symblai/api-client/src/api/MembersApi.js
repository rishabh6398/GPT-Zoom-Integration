...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MemberListResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/MemberListResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.MembersApi = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.MemberListResponse);
  }
}(this, function(ApiClient, MemberListResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/MembersApi~getMembersByConversationIdCallback
     ...
     * @param {module:api/MembersApi~getMembersByConversationIdCallback} callback The callback function, accepting three arguments: error, data, response
