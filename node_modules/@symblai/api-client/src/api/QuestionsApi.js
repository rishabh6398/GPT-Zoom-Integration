...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/QuestionListResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/QuestionListResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.QuestionsApi = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.QuestionListResponse);
  }
}(this, function(ApiClient, QuestionListResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/QuestionsApi~getQuestionsByConversationIdCallback
     ...
     * @param {module:api/QuestionsApi~getQuestionsByConversationIdCallback} callback The callback function, accepting three arguments: error, data, response
