...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TopicListResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/TopicListResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.TopicsApi = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.TopicListResponse);
  }
}(this, function(ApiClient, TopicListResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/TopicsApi~getTopicsByConversationIdCallback
     ...
     * @param {module:api/TopicsApi~getTopicsByConversationIdCallback} callback The callback function, accepting three arguments: error, data, response
