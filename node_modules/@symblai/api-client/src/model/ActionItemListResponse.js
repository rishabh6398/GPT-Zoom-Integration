...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConversationActionItem'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConversationActionItem'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.ActionItemListResponse = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.ConversationActionItem);
  }
}(this, function(ApiClient, ConversationActionItem) {
  'use strict';
  ...
  /**
   * The ActionItemListResponse model module.
   * @module model/ActionItemListResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ActionItemListResponse</code>.
   * @alias module:model/ActionItemListResponse
   * @class
   * @param actionItems {Array.<module:model/ConversationActionItem>} 
   */
  var exports = function(actionItems) {
    var _this = this;
  ...
  /**
   * Constructs a <code>ActionItemListResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ActionItemListResponse} obj Optional instance to populate.
   * @return {module:model/ActionItemListResponse} The populated <code>ActionItemListResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('actionItems')) {
        obj['actionItems'] = ApiClient.convertToType(data['actionItems'], [ConversationActionItem]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/ConversationActionItem>} actionItems
   */
  exports.prototype['actionItems'] = undefined;
