...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.AudioConfig = factory(root.SymblaiApIs.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payloadType')) {
        obj['payloadType'] = ApiClient.convertToType(data['payloadType'], 'Number');
      }
    }
    return obj;
  }
  ...
  /**
   * Sample Size for the audio stream
   * @member {Number} sampleSize
   */
  exports.prototype['sampleSize'] = undefined;
  /**
   * Payload Type for the given codec
   * @member {Number} payloadType
   */
  exports.prototype['payloadType'] = undefined;
