...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.ChannelTrunc = factory(root.SymblaiApIs.ApiClient);
  }
  ...
  /**
   * The ChannelTrunc model module.
   * @module model/ChannelTrunc
   * @version 1.0
   */

  /**
   * Constructs a new <code>ChannelTrunc</code>.
   * @alias module:model/ChannelTrunc
   * @class
   */
  ...
  /**
   * Constructs a <code>ChannelTrunc</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ChannelTrunc} obj Optional instance to populate.
   * @return {module:model/ChannelTrunc} The populated <code>ChannelTrunc</code> instance.
   */
