...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DueBy', 'model/MembersInfo', 'model/Tag'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DueBy'), require('./MembersInfo'), require('./Tag'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.ConversationActionItem = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.DueBy, root.SymblaiApIs.MembersInfo, root.SymblaiApIs.Tag);
  }
}(this, function(ApiClient, DueBy, MembersInfo, Tag) {
  'use strict';
  ...
  /**
   * The ConversationActionItem model module.
   * @module model/ConversationActionItem
   * @version 1.0
   */

  /**
   * Constructs a new <code>ConversationActionItem</code>.
   * @alias module:model/ConversationActionItem
   * @class
   */
  ...
  /**
   * Constructs a <code>ConversationActionItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConversationActionItem} obj Optional instance to populate.
   * @return {module:model/ConversationActionItem} The populated <code>ConversationActionItem</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('entities')) {
        obj['entities'] = ApiClient.convertToType(data['entities'], [Tag]);
      }
      if (data.hasOwnProperty('assignee')) {
        obj['assignee'] = MembersInfo.constructFromObject(data['assignee']);
      }
      if (data.hasOwnProperty('dueBy')) {
        obj['dueBy'] = DueBy.constructFromObject(data['dueBy']);
      }
    }
    return obj;
  }
  ...
  /**
   * Array of message reference ids
   * @member {Array.<String>} messageIds
   */
  exports.prototype['messageIds'] = undefined;
  /**
   * @member {Array.<module:model/Tag>} entities
   */
  exports.prototype['entities'] = undefined;
  /**
   * @member {module:model/MembersInfo} assignee
   */
  exports.prototype['assignee'] = undefined;
  /**
   * @member {module:model/DueBy} dueBy
   */
  exports.prototype['dueBy'] = undefined;
