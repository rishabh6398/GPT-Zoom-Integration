...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.ConversationFollowUp = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.Tag);
  }
  ...
  /**
   * The ConversationFollowUp model module.
   * @module model/ConversationFollowUp
   * @version 1.0
   */

  /**
   * Constructs a new <code>ConversationFollowUp</code>.
   * @alias module:model/ConversationFollowUp
   * @class
   */
  ...
  /**
   * Constructs a <code>ConversationFollowUp</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConversationFollowUp} obj Optional instance to populate.
   * @return {module:model/ConversationFollowUp} The populated <code>ConversationFollowUp</code> instance.
   */
