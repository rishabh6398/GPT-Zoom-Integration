...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.ConversationInsightItem = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.Tag);
  }
  ...
  /**
   * The ConversationInsightItem model module.
   * @module model/ConversationInsightItem
   * @version 1.0
   */

  /**
   * Constructs a new <code>ConversationInsightItem</code>.
   * @alias module:model/ConversationInsightItem
   * @class
   */
  ...
  /**
   * Constructs a <code>ConversationInsightItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConversationInsightItem} obj Optional instance to populate.
   * @return {module:model/ConversationInsightItem} The populated <code>ConversationInsightItem</code> instance.
   */
