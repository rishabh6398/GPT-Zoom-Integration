...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.ConversationIntent = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.Tag);
  }
  ...
  /**
   * The ConversationIntent model module.
   * @module model/ConversationIntent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ConversationIntent</code>.
   * @alias module:model/ConversationIntent
   * @class
   */
  ...
  /**
   * Constructs a <code>ConversationIntent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConversationIntent} obj Optional instance to populate.
   * @return {module:model/ConversationIntent} The populated <code>ConversationIntent</code> instance.
   */
  ...
  /**
   * List of other intents detected with scores
