...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.ConversationMessage = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.MembersInfo);
  }
   ...
   * @module model/ConversationMessage
   * @version 1.0
   */

  /**
   * Constructs a new <code>ConversationMessage</code>.
   * @alias module:model/ConversationMessage
   * @class
   */
   ...
   * @param {module:model/ConversationMessage} obj Optional instance to populate.
   * @return {module:model/ConversationMessage} The populated <code>ConversationMessage</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('from')) {
        obj['from'] = MembersInfo.constructFromObject(data['from']);
      }
      ...
      if (data.hasOwnProperty('transcriptId')) {
        obj['transcriptId'] = ApiClient.convertToType(data['transcriptId'], 'String');
      }
  ...
  /**
   * @member {module:model/MembersInfo} from
   */
  ...
  /**
   * @member {String} transcriptId
   */
  exports.prototype['transcriptId'] = undefined;
  /**
