...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.ConversationQuestion = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.Tag);
  }
  ...
  /**
   * The ConversationQuestion model module.
   * @module model/ConversationQuestion
   * @version 1.0
   */

  /**
   * Constructs a new <code>ConversationQuestion</code>.
   * @alias module:model/ConversationQuestion
   * @class
   */
  ...
  /**
   * Constructs a <code>ConversationQuestion</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConversationQuestion} obj Optional instance to populate.
   * @return {module:model/ConversationQuestion} The populated <code>ConversationQuestion</code> instance.
   */
