...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.ConversationTopic = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.Tag);
  }
  ...
  /**
   * The ConversationTopic model module.
   * @module model/ConversationTopic
   * @version 1.0
   */

  /**
   * Constructs a new <code>ConversationTopic</code>.
   * @alias module:model/ConversationTopic
   * @class
   */
  ...
  /**
   * Constructs a <code>ConversationTopic</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConversationTopic} obj Optional instance to populate.
   * @return {module:model/ConversationTopic} The populated <code>ConversationTopic</code> instance.
   */
