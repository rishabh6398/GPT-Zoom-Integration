...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.DueBy = factory(root.SymblaiApIs.ApiClient);
  }
  ...
  /**
   * The DueBy model module.
   * @module model/DueBy
   * @version 1.0
   */

  /**
   * Constructs a new <code>DueBy</code>.
   * @alias module:model/DueBy
   * @class
   */
  ...
  /**
   * Constructs a <code>DueBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DueBy} obj Optional instance to populate.
   * @return {module:model/DueBy} The populated <code>DueBy</code> instance.
   */
  ...
  /**
   * Date/Time value due date/time in ISO 8601 format. This will be always populated even when start and end are populated when due date/time is a range.
   * @member {Date} value
   */
  exports.prototype['value'] = undefined;
  /**
   * Date/Time start value if due date/time is a range.
   * @member {Date} start
   */
  exports.prototype['start'] = undefined;
  /**
   * Date/Time end value if due date/time is a range.
   * @member {Date} end
   */
