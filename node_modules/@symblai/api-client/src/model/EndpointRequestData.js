...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SessionTrunc'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SessionTrunc'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.EndpointRequestData = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.SessionTrunc);
  }
}(this, function(ApiClient, SessionTrunc) {
  'use strict';
  ...
  /**
   * The EndpointRequestData model module.
   * @module model/EndpointRequestData
   * @version 1.0
   */

  /**
   * Constructs a new <code>EndpointRequestData</code>.
   * @alias module:model/EndpointRequestData
   * @class
   */
  ...
  /**
   * Constructs a <code>EndpointRequestData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EndpointRequestData} obj Optional instance to populate.
   * @return {module:model/EndpointRequestData} The populated <code>EndpointRequestData</code> instance.
   */
