...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UserTrunc'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UserTrunc'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.ExternalEvent = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.UserTrunc);
  }
}(this, function(ApiClient, UserTrunc) {
  'use strict';
  ...
  /**
   * The ExternalEvent model module.
   * @module model/ExternalEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ExternalEvent</code>.
   * @alias module:model/ExternalEvent
   * @class
   * @param type {String} The type of supported events
   * @param user {module:model/UserTrunc} The user object for the event
   */
  var exports = function(type, user) {
    var _this = this;
  ...
  /**
   * Constructs a <code>ExternalEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExternalEvent} obj Optional instance to populate.
   * @return {module:model/ExternalEvent} The populated <code>ExternalEvent</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('user')) {
        obj['user'] = UserTrunc.constructFromObject(data['user']);
      }
    }
    return obj;
  }
  ...
  /**
   * The topics for which events will occur
   * @member {module:model/ExternalEvent.TopicEnum} topic
   */
  exports.prototype['topic'] = undefined;
  /**
   * The type of supported events
   * @member {String} type
   */
  exports.prototype['type'] = undefined;
  /**
   * The user object for the event
   * @member {module:model/UserTrunc} user
   */
