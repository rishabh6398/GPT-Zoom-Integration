...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConversationFollowUp'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConversationFollowUp'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.FollowUpListResponse = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.ConversationFollowUp);
  }
}(this, function(ApiClient, ConversationFollowUp) {
  'use strict';
  ...
  /**
   * The FollowUpListResponse model module.
   * @module model/FollowUpListResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>FollowUpListResponse</code>.
   * @alias module:model/FollowUpListResponse
   * @class
   * @param followUps {Array.<module:model/ConversationFollowUp>} 
   */
  var exports = function(followUps) {
    var _this = this;
  ...
  /**
   * Constructs a <code>FollowUpListResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FollowUpListResponse} obj Optional instance to populate.
   * @return {module:model/FollowUpListResponse} The populated <code>FollowUpListResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('followUps')) {
        obj['followUps'] = ApiClient.convertToType(data['followUps'], [ConversationFollowUp]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/ConversationFollowUp>} followUps
   */
  exports.prototype['followUps'] = undefined;
