...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.Hint = factory(root.SymblaiApIs.ApiClient);
  }
  ...
  /**
   * The Hint model module.
   * @module model/Hint
   * @version 1.0
   */

  /**
   * Constructs a new <code>Hint</code>.
   * @alias module:model/Hint
   * @class
   */
  ...
  /**
   * Constructs a <code>Hint</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Hint} obj Optional instance to populate.
   * @return {module:model/Hint} The populated <code>Hint</code> instance.
   */
