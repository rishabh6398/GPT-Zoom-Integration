...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConversationInsightItem'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConversationInsightItem'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.InsightsListResponse = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.ConversationInsightItem);
  }
}(this, function(ApiClient, ConversationInsightItem) {
  'use strict';
  ...
  /**
   * The InsightsListResponse model module.
   * @module model/InsightsListResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>InsightsListResponse</code>.
   * @alias module:model/InsightsListResponse
   * @class
   * @param insights {Array.<module:model/ConversationInsightItem>} 
   */
  var exports = function(insights) {
    var _this = this;
  ...
  /**
   * Constructs a <code>InsightsListResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InsightsListResponse} obj Optional instance to populate.
   * @return {module:model/InsightsListResponse} The populated <code>InsightsListResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('insights')) {
        obj['insights'] = ApiClient.convertToType(data['insights'], [ConversationInsightItem]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/ConversationInsightItem>} insights
   */
