...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Error', 'model/InsightItem', 'model/Message'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Error'), require('./InsightItem'), require('./Message'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.InsightsResponse = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.Error, root.SymblaiApIs.InsightItem, root.SymblaiApIs.Message);
  }
}(this, function(ApiClient, Error, InsightItem, Message) {
  'use strict';
  ...
  /**
   * The InsightsResponse model module.
   * @module model/InsightsResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>InsightsResponse</code>.
   * @alias module:model/InsightsResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>InsightsResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InsightsResponse} obj Optional instance to populate.
   * @return {module:model/InsightsResponse} The populated <code>InsightsResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('insights')) {
        obj['insights'] = ApiClient.convertToType(data['insights'], [InsightItem]);
      }
  ...
  /**
   * @member {Array.<module:model/InsightItem>} insights
   */
