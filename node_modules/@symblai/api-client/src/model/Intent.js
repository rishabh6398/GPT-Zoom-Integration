...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.Intent = factory(root.SymblaiApIs.ApiClient);
  }
   ...
   * @class
   * @param intent {module:model/Intent.IntentEnum} The intents to be detected
   */
  var exports = function(intent) {
    var _this = this;
  ...
  /**
   * The intents to be detected
   * @member {module:model/Intent.IntentEnum} intent
   */
  exports.prototype['intent'] = undefined;
  /**
   * The silence timeout in seconds to consider before stopping to detect intents
   * @member {Number} silenceTimeout
   */
  exports.prototype['silenceTimeout'] = undefined;
