...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConversationIntent'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConversationIntent'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.IntentListResponse = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.ConversationIntent);
  }
}(this, function(ApiClient, ConversationIntent) {
  'use strict';
  ...
  /**
   * The IntentListResponse model module.
   * @module model/IntentListResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>IntentListResponse</code>.
   * @alias module:model/IntentListResponse
   * @class
   * @param intents {Array.<module:model/ConversationIntent>} 
   */
  var exports = function(intents) {
    var _this = this;
  ...
  /**
   * Constructs a <code>IntentListResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IntentListResponse} obj Optional instance to populate.
   * @return {module:model/IntentListResponse} The populated <code>IntentListResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('intents')) {
        obj['intents'] = ApiClient.convertToType(data['intents'], [ConversationIntent]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/ConversationIntent>} intents
   */
