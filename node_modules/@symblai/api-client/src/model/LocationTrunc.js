...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.LocationTrunc = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.TimeZone);
  }
  ...
  /**
   * The LocationTrunc model module.
   * @module model/LocationTrunc
   * @version 1.0
   */

  /**
   * Constructs a new <code>LocationTrunc</code>.
   * @alias module:model/LocationTrunc
   * @class
   */
  ...
  /**
   * Constructs a <code>LocationTrunc</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LocationTrunc} obj Optional instance to populate.
   * @return {module:model/LocationTrunc} The populated <code>LocationTrunc</code> instance.
   */
