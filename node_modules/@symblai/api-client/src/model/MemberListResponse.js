...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MembersInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MembersInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.MemberListResponse = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.MembersInfo);
  }
}(this, function(ApiClient, MembersInfo) {
  'use strict';
  ...
  /**
   * The MemberListResponse model module.
   * @module model/MemberListResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>MemberListResponse</code>.
   * @alias module:model/MemberListResponse
   * @class
   * @param members {Array.<module:model/MembersInfo>} 
   */
  ...
  /**
   * Constructs a <code>MemberListResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MemberListResponse} obj Optional instance to populate.
   * @return {module:model/MemberListResponse} The populated <code>MemberListResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('members')) {
        obj['members'] = ApiClient.convertToType(data['members'], [MembersInfo]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/MembersInfo>} members
   */
