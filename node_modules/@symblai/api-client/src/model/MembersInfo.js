...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.MembersInfo = factory(root.SymblaiApIs.ApiClient);
  }
   ...
   * @module model/MembersInfo
   * @version 1.0
   */

  /**
   * Constructs a new <code>MembersInfo</code>.
   * @alias module:model/MembersInfo
   * @class
   */
   ...
   * @param {module:model/MembersInfo} obj Optional instance to populate.
   * @return {module:model/MembersInfo} The populated <code>MembersInfo</code> instance.
   */
