...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ChannelTrunc', 'model/Metadata', 'model/Payload', 'model/SessionTrunc', 'model/UserTrunc'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ChannelTrunc'), require('./Metadata'), require('./Payload'), require('./SessionTrunc'), require('./UserTrunc'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.Message = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.ChannelTrunc, root.SymblaiApIs.Metadata, root.SymblaiApIs.Payload, root.SymblaiApIs.SessionTrunc, root.SymblaiApIs.UserTrunc);
  }
}(this, function(ApiClient, ChannelTrunc, Metadata, Payload, SessionTrunc, UserTrunc) {
  'use strict';
   ...
   * @class
   * @param session {module:model/SessionTrunc} 
   * @param from {module:model/UserTrunc} 
   * @param payload {module:model/Payload} 
   */
  var exports = function(session, from, payload) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('session')) {
        obj['session'] = SessionTrunc.constructFromObject(data['session']);
      }
      if (data.hasOwnProperty('from')) {
        obj['from'] = UserTrunc.constructFromObject(data['from']);
      }
      if (data.hasOwnProperty('to')) {
        obj['to'] = ApiClient.convertToType(data['to'], [UserTrunc]);
      }
      if (data.hasOwnProperty('payload')) {
        obj['payload'] = Payload.constructFromObject(data['payload']);
      }
      if (data.hasOwnProperty('channel')) {
        obj['channel'] = ChannelTrunc.constructFromObject(data['channel']);
      }
  ...
  /**
   * @member {module:model/SessionTrunc} session
   */
  exports.prototype['session'] = undefined;
  /**
   * @member {module:model/UserTrunc} from
   */
  exports.prototype['from'] = undefined;
  /**
   * @member {Array.<module:model/UserTrunc>} to
   */
  ...
  /**
   * @member {module:model/ChannelTrunc} channel
   */
