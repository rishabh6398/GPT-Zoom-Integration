...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConversationMessage'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConversationMessage'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.MessageListResponse = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.ConversationMessage);
  }
}(this, function(ApiClient, ConversationMessage) {
  'use strict';
   ...
   * @class
   * @param messages {Array.<module:model/ConversationMessage>} 
   */
  ...
  /**
   * @member {Array.<module:model/ConversationMessage>} messages
   */
