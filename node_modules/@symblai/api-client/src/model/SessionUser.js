...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.SessionUser = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.UserTrunc);
  }
  ...
  /**
   * The SessionUser model module.
   * @module model/SessionUser
   * @version 1.0
   */

  /**
   * Constructs a new <code>SessionUser</code>.
   * @alias module:model/SessionUser
   * @class
   */
  ...
  /**
   * Constructs a <code>SessionUser</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SessionUser} obj Optional instance to populate.
   * @return {module:model/SessionUser} The populated <code>SessionUser</code> instance.
   */
  ...
  /**
   * @member {module:model/SessionUser.StatusEnum} status
   */
  exports.prototype['status'] = undefined;
  /**
   * The mode of user's joining the session
   * @member {module:model/SessionUser.ModeEnum} mode
   */
