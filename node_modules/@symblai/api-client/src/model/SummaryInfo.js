...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SymblaiApIs.SummaryInfo = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.UserTrunc);
  }
  ...
  /**
   * The SummaryInfo model module.
   * @module model/SummaryInfo
   * @version 1.0
   */

  /**
   * Constructs a new <code>SummaryInfo</code>.
   * @alias module:model/SummaryInfo
   * @class
   */
  ...
  /**
   * Constructs a <code>SummaryInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SummaryInfo} obj Optional instance to populate.
   * @return {module:model/SummaryInfo} The populated <code>SummaryInfo</code> instance.
   */
  ...
  /**
   * User specific details for Summary UI
   * @member {module:model/UserTrunc} user
   */
  exports.prototype['user'] = undefined;
  /**
   * The URL for post meeting Summary UI
   * @member {String} url
   */
