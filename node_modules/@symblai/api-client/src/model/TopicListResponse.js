...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConversationTopic'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConversationTopic'));
  } else {
    // Browser globals (root is window)
    if (!root.SymblaiApIs) {
      root.SymblaiApIs = {};
    }
    root.SymblaiApIs.TopicListResponse = factory(root.SymblaiApIs.ApiClient, root.SymblaiApIs.ConversationTopic);
  }
}(this, function(ApiClient, ConversationTopic) {
  'use strict';
  ...
  /**
   * The TopicListResponse model module.
   * @module model/TopicListResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>TopicListResponse</code>.
   * @alias module:model/TopicListResponse
   * @class
   * @param topics {Array.<module:model/ConversationTopic>} 
   */
  var exports = function(topics) {
    var _this = this;
  ...
  /**
   * Constructs a <code>TopicListResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TopicListResponse} obj Optional instance to populate.
   * @return {module:model/TopicListResponse} The populated <code>TopicListResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('topics')) {
        obj['topics'] = ApiClient.convertToType(data['topics'], [ConversationTopic]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/ConversationTopic>} topics
   */
