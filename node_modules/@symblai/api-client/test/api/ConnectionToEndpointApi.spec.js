...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.ConnectionToEndpointApi();
  });
  ...
  describe('ConnectionToEndpointApi', function() {
    describe('connectToEndpoint', function() {
      it('should call connectToEndpoint successfully', function(done) {
        //uncomment below and update the code to test connectToEndpoint
        //instance.connectToEndpoint(function(error) {
