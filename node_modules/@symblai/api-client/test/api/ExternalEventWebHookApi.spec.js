...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.ExternalEventWebHookApi();
  });
  ...
  describe('ExternalEventWebHookApi', function() {
    describe('externalEventWebHook', function() {
      it('should call externalEventWebHook successfully', function(done) {
        //uncomment below and update the code to test externalEventWebHook
        //instance.externalEventWebHook(function(error) {
