...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.LanguageInsightsApi();
  });
  ...
  describe('LanguageInsightsApi', function() {
    describe('generateInsights', function() {
      it('should call generateInsights successfully', function(done) {
        //uncomment below and update the code to test generateInsights
        //instance.generateInsights(function(error) {
