...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.Action();
  });
  ...
  describe('Action', function() {
    it('should create an instance of Action', function() {
      ...
      //var instane = new SymblaiApIs.Action();
      //expect(instance).to.be.a(SymblaiApIs.Action);
    });

    it('should have the property invokeOn (base name: "invokeOn")', function() {
      // uncomment below and update the code to test the property invokeOn
      //var instane = new SymblaiApIs.Action();
