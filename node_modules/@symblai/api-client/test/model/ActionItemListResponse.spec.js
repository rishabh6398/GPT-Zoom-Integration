...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.ActionItemListResponse();
  });
  ...
  describe('ActionItemListResponse', function() {
    it('should create an instance of ActionItemListResponse', function() {
      // uncomment below and update the code to test ActionItemListResponse
      //var instane = new SymblaiApIs.ActionItemListResponse();
      //expect(instance).to.be.a(SymblaiApIs.ActionItemListResponse);
    });

    it('should have the property actionItems (base name: "actionItems")', function() {
      // uncomment below and update the code to test the property actionItems
      //var instane = new SymblaiApIs.ActionItemListResponse();
