...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.ChannelTrunc();
  });
  ...
  describe('ChannelTrunc', function() {
    it('should create an instance of ChannelTrunc', function() {
      // uncomment below and update the code to test ChannelTrunc
      //var instane = new SymblaiApIs.ChannelTrunc();
      //expect(instance).to.be.a(SymblaiApIs.ChannelTrunc);
    });
