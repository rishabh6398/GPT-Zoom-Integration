...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.ConversationActionItem();
  });
  ...
  describe('ConversationActionItem', function() {
    it('should create an instance of ConversationActionItem', function() {
      // uncomment below and update the code to test ConversationActionItem
      //var instane = new SymblaiApIs.ConversationActionItem();
      //expect(instance).to.be.a(SymblaiApIs.ConversationActionItem);
    });
    ...
    it('should have the property dueBy (base name: "dueBy")', function() {
      // uncomment below and update the code to test the property dueBy
      //var instane = new SymblaiApIs.ConversationActionItem();
      //expect(instance).to.be();
    });
