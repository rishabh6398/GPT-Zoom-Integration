...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.ConversationFollowUp();
  });
  ...
  describe('ConversationFollowUp', function() {
    it('should create an instance of ConversationFollowUp', function() {
      // uncomment below and update the code to test ConversationFollowUp
      //var instane = new SymblaiApIs.ConversationFollowUp();
      //expect(instance).to.be.a(SymblaiApIs.ConversationFollowUp);
    });
