...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.ConversationInsightItem();
  });
  ...
  describe('ConversationInsightItem', function() {
    it('should create an instance of ConversationInsightItem', function() {
      // uncomment below and update the code to test ConversationInsightItem
      //var instane = new SymblaiApIs.ConversationInsightItem();
      //expect(instance).to.be.a(SymblaiApIs.ConversationInsightItem);
    });
