...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.ConversationIntent();
  });
  ...
  describe('ConversationIntent', function() {
    it('should create an instance of ConversationIntent', function() {
      // uncomment below and update the code to test ConversationIntent
      //var instane = new SymblaiApIs.ConversationIntent();
      //expect(instance).to.be.a(SymblaiApIs.ConversationIntent);
    });
