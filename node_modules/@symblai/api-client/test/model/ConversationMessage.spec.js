...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.ConversationMessage();
  });
  ...
  describe('ConversationMessage', function() {
    it('should create an instance of ConversationMessage', function() {
      // uncomment below and update the code to test ConversationMessage
      //var instane = new SymblaiApIs.ConversationMessage();
      //expect(instance).to.be.a(SymblaiApIs.ConversationMessage);
    });
    ...
    it('should have the property transcriptId (base name: "transcriptId")', function() {
      // uncomment below and update the code to test the property transcriptId
      //var instane = new SymblaiApIs.ConversationMessage();
      //expect(instance).to.be();
    });
