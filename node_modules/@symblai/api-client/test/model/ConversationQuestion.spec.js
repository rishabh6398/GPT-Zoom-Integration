...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.ConversationQuestion();
  });
  ...
  describe('ConversationQuestion', function() {
    it('should create an instance of ConversationQuestion', function() {
      // uncomment below and update the code to test ConversationQuestion
      //var instane = new SymblaiApIs.ConversationQuestion();
      //expect(instance).to.be.a(SymblaiApIs.ConversationQuestion);
    });
