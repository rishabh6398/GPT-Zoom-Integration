...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.ConversationTopic();
  });
  ...
  describe('ConversationTopic', function() {
    it('should create an instance of ConversationTopic', function() {
      // uncomment below and update the code to test ConversationTopic
      //var instane = new SymblaiApIs.ConversationTopic();
      //expect(instance).to.be.a(SymblaiApIs.ConversationTopic);
    });
