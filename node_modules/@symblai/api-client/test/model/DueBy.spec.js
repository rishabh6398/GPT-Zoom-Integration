...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.DueBy();
  });
  ...
  describe('DueBy', function() {
    it('should create an instance of DueBy', function() {
      // uncomment below and update the code to test DueBy
      //var instane = new SymblaiApIs.DueBy();
      //expect(instance).to.be.a(SymblaiApIs.DueBy);
    });
