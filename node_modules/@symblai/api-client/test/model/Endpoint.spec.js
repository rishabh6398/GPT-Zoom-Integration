...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.Endpoint();
  });
  ...
  describe('Endpoint', function() {
    it('should create an instance of Endpoint', function() {
      ...
      //var instane = new SymblaiApIs.Endpoint();
      //expect(instance).to.be.a(SymblaiApIs.Endpoint);
    });
    ...
    it('should have the property transportConfig (base name: "transportConfig")', function() {
      // uncomment below and update the code to test the property transportConfig
      //var instane = new SymblaiApIs.Endpoint();
      //expect(instance).to.be();
    });
