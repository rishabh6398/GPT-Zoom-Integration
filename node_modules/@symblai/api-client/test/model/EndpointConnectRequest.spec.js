...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.EndpointConnectRequest();
  });
  ...
  describe('EndpointConnectRequest', function() {
    it('should create an instance of EndpointConnectRequest', function() {
      // uncomment below and update the code to test EndpointConnectRequest
      //var instane = new SymblaiApIs.EndpointConnectRequest();
      //expect(instance).to.be.a(SymblaiApIs.EndpointConnectRequest);
    });
    ...
    it('should have the property endpointWebhookUrl (base name: "endpointWebhookUrl")', function() {
      // uncomment below and update the code to test the property endpointWebhookUrl
      //var instane = new SymblaiApIs.EndpointConnectRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property validationToken (base name: "validationToken")', function() {
      // uncomment below and update the code to test the property validationToken
      //var instane = new SymblaiApIs.EndpointConnectRequest();
      //expect(instance).to.be();
    });
