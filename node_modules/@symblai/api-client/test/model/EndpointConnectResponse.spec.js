...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.EndpointConnectResponse();
  });
  ...
  describe('EndpointConnectResponse', function() {
    it('should create an instance of EndpointConnectResponse', function() {
      // uncomment below and update the code to test EndpointConnectResponse
      //var instane = new SymblaiApIs.EndpointConnectResponse();
      //expect(instance).to.be.a(SymblaiApIs.EndpointConnectResponse);
    });
    ...
    it('should have the property resultWebSocketUrl (base name: "resultWebSocketUrl")', function() {
      // uncomment below and update the code to test the property resultWebSocketUrl
      //var instane = new SymblaiApIs.EndpointConnectResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property summaryInfo (base name: "summaryInfo")', function() {
      // uncomment below and update the code to test the property summaryInfo
      //var instane = new SymblaiApIs.EndpointConnectResponse();
      //expect(instance).to.be();
    });
