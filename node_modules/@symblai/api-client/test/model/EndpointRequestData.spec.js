...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.EndpointRequestData();
  });
  ...
  describe('EndpointRequestData', function() {
    it('should create an instance of EndpointRequestData', function() {
      // uncomment below and update the code to test EndpointRequestData
      //var instane = new SymblaiApIs.EndpointRequestData();
      //expect(instance).to.be.a(SymblaiApIs.EndpointRequestData);
    });
