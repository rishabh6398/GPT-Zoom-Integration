...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.ExternalEvent();
  });
  ...
  describe('ExternalEvent', function() {
    it('should create an instance of ExternalEvent', function() {
      // uncomment below and update the code to test ExternalEvent
      //var instane = new SymblaiApIs.ExternalEvent();
      //expect(instance).to.be.a(SymblaiApIs.ExternalEvent);
    });
