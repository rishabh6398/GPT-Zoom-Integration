...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.FollowUpListResponse();
  });
  ...
  describe('FollowUpListResponse', function() {
    it('should create an instance of FollowUpListResponse', function() {
      // uncomment below and update the code to test FollowUpListResponse
      //var instane = new SymblaiApIs.FollowUpListResponse();
      //expect(instance).to.be.a(SymblaiApIs.FollowUpListResponse);
    });

    it('should have the property followUps (base name: "followUps")', function() {
      // uncomment below and update the code to test the property followUps
      //var instane = new SymblaiApIs.FollowUpListResponse();
