...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.Grant();
  });
  ...
  describe('Grant', function() {
    it('should create an instance of Grant', function() {
      // uncomment below and update the code to test Grant
      //var instane = new SymblaiApIs.Grant();
      //expect(instance).to.be.a(SymblaiApIs.Grant);
    });
