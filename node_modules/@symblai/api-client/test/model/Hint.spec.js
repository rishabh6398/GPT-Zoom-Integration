...
(function(root, factory) {
  ...
  describe('Hint', function() {
    it('should create an instance of Hint', function() {
      // uncomment below and update the code to test Hint
      //var instane = new SymblaiApIs.Hint();
      //expect(instance).to.be.a(SymblaiApIs.Hint);
    });
