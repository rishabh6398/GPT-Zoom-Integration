...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.InsightConfig();
  });
  ...
  describe('InsightConfig', function() {
    it('should create an instance of InsightConfig', function() {
      // uncomment below and update the code to test InsightConfig
      //var instane = new SymblaiApIs.InsightConfig();
      //expect(instance).to.be.a(SymblaiApIs.InsightConfig);
    });

    it('should have the property conversationSetting (base name: "conversationSetting")', function() {
      // uncomment below and update the code to test the property conversationSetting
      //var instane = new SymblaiApIs.InsightConfig();
    ...
    it('should have the property disablePunctuation (base name: "disablePunctuation")', function() {
      // uncomment below and update the code to test the property disablePunctuation
      //var instane = new SymblaiApIs.InsightConfig();
      //expect(instance).to.be();
    });
