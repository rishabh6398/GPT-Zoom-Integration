...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.InsightItem();
  });
  ...
  describe('InsightItem', function() {
    it('should create an instance of InsightItem', function() {
      // uncomment below and update the code to test InsightItem
      //var instane = new SymblaiApIs.InsightItem();
      //expect(instance).to.be.a(SymblaiApIs.InsightItem);
    });
