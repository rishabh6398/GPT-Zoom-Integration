...
(function(root, factory) {
  ...
  describe('InsightType', function() {
    it('should create an instance of InsightType', function() {
      // uncomment below and update the code to test InsightType
      //var instane = new SymblaiApIs.InsightType();
      //expect(instance).to.be.a(SymblaiApIs.InsightType);
    });
