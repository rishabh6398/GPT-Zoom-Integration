...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.InsightsListResponse();
  });
  ...
  describe('InsightsListResponse', function() {
    it('should create an instance of InsightsListResponse', function() {
      // uncomment below and update the code to test InsightsListResponse
      //var instane = new SymblaiApIs.InsightsListResponse();
      //expect(instance).to.be.a(SymblaiApIs.InsightsListResponse);
    });
