...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.InsightsRequest();
  });
  ...
  describe('InsightsRequest', function() {
    it('should create an instance of InsightsRequest', function() {
      // uncomment below and update the code to test InsightsRequest
      //var instane = new SymblaiApIs.InsightsRequest();
      //expect(instance).to.be.a(SymblaiApIs.InsightsRequest);
    });

    it('should have the property insightTypes (base name: "insightTypes")', function() {
      // uncomment below and update the code to test the property insightTypes
      //var instane = new SymblaiApIs.InsightsRequest();
