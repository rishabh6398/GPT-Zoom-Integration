...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.InsightsResponse();
  });
  ...
  describe('InsightsResponse', function() {
    it('should create an instance of InsightsResponse', function() {
      // uncomment below and update the code to test InsightsResponse
      //var instane = new SymblaiApIs.InsightsResponse();
      //expect(instance).to.be.a(SymblaiApIs.InsightsResponse);
    });
