...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.IntentListResponse();
  });
  ...
  describe('IntentListResponse', function() {
    it('should create an instance of IntentListResponse', function() {
      // uncomment below and update the code to test IntentListResponse
      //var instane = new SymblaiApIs.IntentListResponse();
      //expect(instance).to.be.a(SymblaiApIs.IntentListResponse);
    });
