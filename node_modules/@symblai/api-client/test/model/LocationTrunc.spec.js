...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.LocationTrunc();
  });
  ...
  describe('LocationTrunc', function() {
    it('should create an instance of LocationTrunc', function() {
      // uncomment below and update the code to test LocationTrunc
      //var instane = new SymblaiApIs.LocationTrunc();
      //expect(instance).to.be.a(SymblaiApIs.LocationTrunc);
    });
