...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.MemberListResponse();
  });
  ...
  describe('MemberListResponse', function() {
    it('should create an instance of MemberListResponse', function() {
      // uncomment below and update the code to test MemberListResponse
      //var instane = new SymblaiApIs.MemberListResponse();
      //expect(instance).to.be.a(SymblaiApIs.MemberListResponse);
    });
