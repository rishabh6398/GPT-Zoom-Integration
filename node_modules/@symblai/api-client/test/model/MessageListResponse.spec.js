...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.MessageListResponse();
  });
  ...
  describe('MessageListResponse', function() {
    it('should create an instance of MessageListResponse', function() {
      // uncomment below and update the code to test MessageListResponse
      //var instane = new SymblaiApIs.MessageListResponse();
      //expect(instance).to.be.a(SymblaiApIs.MessageListResponse);
    });
