...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.QuestionListResponse();
  });
  ...
  describe('QuestionListResponse', function() {
    it('should create an instance of QuestionListResponse', function() {
      // uncomment below and update the code to test QuestionListResponse
      //var instane = new SymblaiApIs.QuestionListResponse();
      //expect(instance).to.be.a(SymblaiApIs.QuestionListResponse);
    });
