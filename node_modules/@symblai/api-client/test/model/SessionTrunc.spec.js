...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.SessionTrunc();
  });
  ...
  describe('SessionTrunc', function() {
    it('should create an instance of SessionTrunc', function() {
      // uncomment below and update the code to test SessionTrunc
      //var instane = new SymblaiApIs.SessionTrunc();
      //expect(instance).to.be.a(SymblaiApIs.SessionTrunc);
    });
