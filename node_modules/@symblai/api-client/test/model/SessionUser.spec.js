...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.SessionUser();
  });
  ...
  describe('SessionUser', function() {
    it('should create an instance of SessionUser', function() {
      // uncomment below and update the code to test SessionUser
      //var instane = new SymblaiApIs.SessionUser();
      //expect(instance).to.be.a(SymblaiApIs.SessionUser);
    });
