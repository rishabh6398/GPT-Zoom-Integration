...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.SummaryInfo();
  });
  ...
  describe('SummaryInfo', function() {
    it('should create an instance of SummaryInfo', function() {
      // uncomment below and update the code to test SummaryInfo
      //var instane = new SymblaiApIs.SummaryInfo();
      //expect(instance).to.be.a(SymblaiApIs.SummaryInfo);
    });
