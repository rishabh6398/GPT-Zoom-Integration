...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.Token();
  });
  ...
  describe('Token', function() {
    it('should create an instance of Token', function() {
      ...
      //var instane = new SymblaiApIs.Token();
      //expect(instance).to.be.a(SymblaiApIs.Token);
    });
    ...
    it('should have the property refershToken (base name: "refershToken")', function() {
      // uncomment below and update the code to test the property refershToken
      //var instane = new SymblaiApIs.Token();
      //expect(instance).to.be();
    });
