...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.TopicListResponse();
  });
  ...
  describe('TopicListResponse', function() {
    it('should create an instance of TopicListResponse', function() {
      // uncomment below and update the code to test TopicListResponse
      //var instane = new SymblaiApIs.TopicListResponse();
      //expect(instance).to.be.a(SymblaiApIs.TopicListResponse);
    });
