...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SymblaiApIs.UserTrunc();
  });
  ...
  describe('UserTrunc', function() {
    it('should create an instance of UserTrunc', function() {
      // uncomment below and update the code to test UserTrunc
      //var instane = new SymblaiApIs.UserTrunc();
      //expect(instance).to.be.a(SymblaiApIs.UserTrunc);
    });
    ...
    it('should have the property preferredGender (base name: "preferredGender")', function() {
      // uncomment below and update the code to test the property preferredGender
      //var instane = new SymblaiApIs.UserTrunc();
      //expect(instance).to.be();
    });
